  ...
  return (
    <section className="section-modern bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <h1 className="heading-modern mb-6 leading-tight">Tasarımlarınızı Hayata Geçirin</h1>

        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
          En kaliteli malzemeler ve son teknoloji baskı makineleri ile tasarımlarınızı mükemmel
          sonuçlarla gerçekleştiriyoruz.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button className="btn-modern text-lg px-8 py-4">Hemen Sipariş Ver</Button>
          <Button
            variant="outline"
